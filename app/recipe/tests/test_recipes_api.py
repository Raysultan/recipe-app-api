...
def sample_ingredient(user, name='Cucumber Sample'):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Vegetarian')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Meat soup')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Cow soup')
        recipe2 = sample_recipe(user=self.user, title='Beet soup')
        ingredient1 = sample_ingredient(user=self.user, name='Meat')
        ingredient2 = sample_ingredient(user=self.user, name='Beet')
